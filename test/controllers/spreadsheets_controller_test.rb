...
class SpreadsheetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spreadsheet" do
    assert_difference('Spreadsheet.count') do
      post spreadsheets_url, params: { spreadsheet: { content: @spreadsheet.content, title: @spreadsheet.title } }
    end
  ...
  test "should update spreadsheet" do
    patch spreadsheet_url(@spreadsheet), params: { spreadsheet: { content: @spreadsheet.content, title: @spreadsheet.title } }
